...
// const Profile = () => {
//   //using auth context to get user data
//   // const { user, isUserAuthenticated, loading, logout } = useAuth();
//   const [user, setUser] = useState(null); // Local state for user data
//   const [loading, setLoading] = useState(true); // Local loading this.state.
//   const [isUserAuthenticated, setIsUserAuthenticated] = useState(false); // Local state for authentication status
//   const Navigate = useNavigate(); // Use useNavigate hook for navigation

//   const userId = (localStorage.getItem("userId") || "").replaceAll(/"/g, ""); // Get user ID from localStorage

//   const API_BASE_URL = import.meta.env.VITE_BACKEND_URL; // Get API base URL from environment variables

//   //using localstorage to get userId
//   useEffect(() => {
...
//         setIsUserAuthenticated(true); // Set authentication status to true
//       } catch (error) {
//         console.log("error fetching user profile:", error);
//         setUser(null); // Reset user data on error
//         setIsUserAuthenticated(false); // Reset authentication status on error
//       } finally {
...
//   }, [API_BASE_URL, userId]); // Dependencies for useEffect
