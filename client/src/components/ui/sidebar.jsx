...
// Removed type definition for SidebarContext
const SidebarContext = React.createContext(null); // Removed type argument
...
const SidebarProvider = React.forwardRef(
  (
    ...
    // Removed type annotation for 'value'
    ...
    // Removed type annotation for contextValue
